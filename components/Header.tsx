      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-300 font-semibold text-sm sm:text-base">Assignment & Activity Management</p>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-3">
            <button
              onClick={onViewSubjects}
              className="p-2 rounded-full text-slate-500 dark:text-slate-400 hover:bg-sky-200/70 dark:hover:bg-sky-800/70 hover:text-sky-600 dark:hover:text-sky-400 transition-all duration-200 hover:scale-110"
            ...
            <button
              ...
              className="p-2 rounded-full text-slate-500 dark:text-slate-400 hover:bg-amber-200/70 dark:hover:bg-amber-800/70 hover:text-amber-600 dark:hover:text-amber-400 transition-all duration-200 hover:scale-110"
        ...
        <div className="bg-gradient-to-br from-slate-200/60 via-sky-100/60 to-slate-200/60 dark:from-slate-900/60 dark:via-slate-800/60 dark:to-slate-900/60 rounded-xl p-4 border border-slate-300/70 dark:border-slate-700/70 shadow-xl backdrop-blur-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                <div className="flex-shrink-0 text-center">
                    ...
                    >
                        <TornadoIcon className="w-full h-full text-slate-500 dark:text-slate-400 group-hover:text-sky-500 transition-colors duration-300 animate-float" />
